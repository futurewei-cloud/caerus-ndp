...
import org.apache.spark.sql.execution.datasources.csv.{CSVDataSource, CsvOutputWriter}
 ...
 */
class PushdownFileFormat extends TextBasedFileFormat with DataSourceRegister {
  ...
  override def toString: String = "PushdownCSV"

  override def hashCode(): Int = getClass.hashCode()

  override def equals(other: Any): Boolean = other.isInstanceOf[PushdownFileFormat]
